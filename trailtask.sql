...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 16, 2023 at 01:35 AM
...
(2, '2023_02_15_203406_create_quizes_table', 1),
(3, '2023_02_15_203717_create_question_answers_table', 1);
...
ALTER TABLE `questions`
  ADD CONSTRAINT `questions_quizid_foreign` FOREIGN KEY (`quizId`) REFERENCES `quizes` (`id`) ON DELETE CASCADE;
COMMIT;
